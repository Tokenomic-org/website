...
function getArticleStyle() {
  return '\n<style>\n' +
    ...
    '.article-detail .back-link { display: inline-flex; align-items: center; gap: 8px; color: #4f7287; text-decoration: none; font-size: 14px; font-weight: 500; margin-bottom: 30px; transition: color 0.2s; }\n' +
    '.article-detail .back-link:hover { color: #001f29; }\n' +
    '.article-detail .article-header { margin-bottom: 40px; }\n' +
    '.article-detail .article-meta { display: flex; align-items: center; gap: 16px; margin-bottom: 16px; font-size: 13px; color: #4f7287; text-transform: uppercase; letter-spacing: 0.5px; flex-wrap: wrap; }\n' +
    ...
    '.article-detail .article-author-line { font-size: 15px; color: #4f7287; margin-bottom: 30px; }\n' +
    ...
    '.share-btn { display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 50%; background: #f0f2f5; color: #4f7287; text-decoration: none; transition: all 0.2s; font-size: 16px; border: none; cursor: pointer; }\n' +
    ...
    '.comments-section .comment-count { display: inline-flex; align-items: center; justify-content: center; background: #f0f2f5; color: #4f7287; font-size: 13px; font-weight: 600; padding: 2px 10px; border-radius: 12px; }\n' +
