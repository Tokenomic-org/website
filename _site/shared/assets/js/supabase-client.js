const TokenomicSupabase = {
  ...
  demoData(type) {
    const demos = {
      ...
      communities: [
        { id: 1, name: 'DeFi Fundamentals', description: 'Learn the basics of decentralized finance including lending, borrowing, DEXs, and yield farming. Perfect for newcomers to the DeFi ecosystem.', members_count: 234, access_price_usdc: 25, educator_wallet: '0x742d...bD1e', educator_name: 'Dr. Sarah Chen', level: 'beginner', category: 'DeFi', courses_count: 3, created_at: '2025-01-15', thumbnail_url: '/assets/images/resource/featured-image-10.jpg' },
        { id: 2, name: 'Advanced Tokenomics', description: 'Deep dive into token design, mechanism engineering, and sustainable economic models for Web3 protocols.', members_count: 89, access_price_usdc: 50, educator_wallet: '0x8Ba1...BA72', educator_name: 'Marcus Webb', level: 'advanced', category: 'Tokenomics', courses_count: 2, created_at: '2025-03-01', thumbnail_url: '/assets/images/resource/featured-image-11.jpg' },
        { id: 3, name: 'Yield Strategies', description: 'Master yield farming, liquidity provision, and auto-compounding strategies across DeFi protocols.', members_count: 156, access_price_usdc: 35, educator_wallet: '0x2546...c30', educator_name: 'Aisha Patel', level: 'intermediate', category: 'DeFi', courses_count: 2, created_at: '2025-02-10', thumbnail_url: '/assets/images/resource/featured-image-13.jpg' },
        { id: 4, name: 'Institutional Onboarding', description: 'A practical community for institutional investors entering DeFi. Covers risk frameworks, custody, compliance, and portfolio allocation.', members_count: 67, access_price_usdc: 75, educator_wallet: '0xfC23...A41', educator_name: 'Elena Rossi', level: 'advanced', category: 'DeFi', courses_count: 1, created_at: '2025-04-05', thumbnail_url: '/assets/images/resource/featured-image-15.jpg' },
        { id: 5, name: 'Smart Contract Security', description: 'Learn to identify vulnerabilities, perform security audits, and write safer Solidity code. Hands-on exercises with real exploit case studies.', members_count: 112, access_price_usdc: 45, educator_wallet: '0x8Ba1...BA72', educator_name: 'Marcus Webb', level: 'advanced', category: 'Security', courses_count: 1, created_at: '2025-05-12', thumbnail_url: '/assets/images/resource/featured-image-12.jpg' },
        { id: 6, name: 'DAO Governance Lab', description: 'Explore decentralized governance mechanisms, voting systems, treasury management, and proposal frameworks for DAOs.', members_count: 98, access_price_usdc: 20, educator_wallet: '0x91Ae...C82', educator_name: 'David Okonkwo', level: 'beginner', category: 'Governance', courses_count: 1, created_at: '2025-06-20', thumbnail_url: '/assets/images/resource/featured-image-16.jpg' },
        { id: 7, name: 'Blockchain Builders', description: 'From zero to deploying your first smart contract. Covers Solidity, Foundry, and full-stack dApp development.', members_count: 287, access_price_usdc: 0, educator_wallet: '0x1234...abcd', educator_name: 'Guillaume Lauzier', level: 'beginner', category: 'Technical', courses_count: 2, created_at: '2024-11-01', thumbnail_url: '/assets/images/resource/featured-image-17.jpg' },
        { id: 8, name: 'Regulatory & Compliance Hub', description: 'Navigate the global regulatory landscape for digital assets including MiCA, SEC guidance, and cross-border compliance frameworks.', members_count: 73, access_price_usdc: 40, educator_wallet: '0xbDA5...97E', educator_name: 'James Liu', level: 'intermediate', category: 'Compliance', courses_count: 1, created_at: '2025-07-15', thumbnail_url: '/assets/images/resource/featured-image-14.jpg' }
      ],
      courses: [
        { id: 1, title: 'Introduction to DeFi', description: 'A comprehensive introduction to decentralized finance covering lending, borrowing, DEXs, and yield farming fundamentals.', modules_count: 12, enrolled_count: 180, price_usdc: 15, status: 'active', community_id: 1, level: 'beginner', category: 'DeFi', educator_id: 1, educator_name: 'Dr. Sarah Chen', thumbnail_url: '/assets/images/resource/featured-image-10.jpg', estimatedHours: 18, whatYouLearn: ['DeFi protocol mechanics', 'Lending & borrowing basics', 'DEX trading fundamentals', 'Yield farming strategies'] },
        { id: 2, title: 'Tokenomics Design Masterclass', description: 'Learn to architect sustainable token economies with real-world case studies from top DeFi protocols.', modules_count: 8, enrolled_count: 67, price_usdc: 30, status: 'active', community_id: 2, level: 'advanced', category: 'Tokenomics', educator_id: 1, educator_name: 'Dr. Sarah Chen', thumbnail_url: '/assets/images/resource/featured-image-11.jpg', estimatedHours: 14, whatYouLearn: ['Token supply mechanics', 'Incentive alignment', 'Governance design', 'Vesting & distribution'] },
        { id: 3, title: 'Smart Contract Security Auditing', description: 'Master security auditing for Solidity smart contracts. Covers common vulnerabilities, testing frameworks, and formal verification.', modules_count: 10, enrolled_count: 45, price_usdc: 40, status: 'active', community_id: 1, level: 'advanced', category: 'Security', educator_id: 2, educator_name: 'Marcus Webb', thumbnail_url: '/assets/images/resource/featured-image-12.jpg', estimatedHours: 22, whatYouLearn: ['Reentrancy & flash loan attacks', 'Formal verification', 'Fuzzing with Foundry', 'Audit report writing'] },
        { id: 4, title: 'DeFi Protocol Strategy', description: 'Understand liquidity provisioning, impermanent loss, and advanced LP strategies across multiple protocols.', modules_count: 6, enrolled_count: 112, price_usdc: 25, status: 'active', community_id: 3, level: 'intermediate', category: 'DeFi', educator_id: 3, educator_name: 'Aisha Patel', thumbnail_url: '/assets/images/resource/featured-image-13.jpg', estimatedHours: 10, whatYouLearn: ['Liquidity pool mechanics', 'Impermanent loss calculation', 'Multi-protocol strategies', 'Risk management'] },
        { id: 5, title: 'Crypto Regulatory Landscape', description: 'Navigate the global regulatory environment for digital assets, covering US, EU, and APAC frameworks.', modules_count: 7, enrolled_count: 89, price_usdc: 35, status: 'active', community_id: null, level: 'intermediate', category: 'Compliance', educator_id: 4, educator_name: 'James Liu', thumbnail_url: '/assets/images/resource/featured-image-14.jpg', estimatedHours: 12, whatYouLearn: ['MiCA regulation overview', 'US SEC guidance', 'KYC/AML for DeFi', 'Cross-border compliance'] },
        { id: 6, title: 'Institutional DeFi Onboarding', description: 'A practical guide for institutional investors entering DeFi. Covers risk frameworks, custody, and compliance requirements.', modules_count: 9, enrolled_count: 54, price_usdc: 50, status: 'active', community_id: 4, level: 'advanced', category: 'DeFi', educator_id: 5, educator_name: 'Elena Rossi', thumbnail_url: '/assets/images/resource/featured-image-15.jpg', estimatedHours: 16, whatYouLearn: ['Institutional custody', 'Risk assessment frameworks', 'Portfolio allocation', 'Reporting & compliance'] },
        { id: 7, title: 'DAO Governance Fundamentals', description: 'Learn the principles of decentralized governance, voting mechanisms, and treasury management for DAOs.', modules_count: 8, enrolled_count: 76, price_usdc: 20, status: 'active', community_id: null, level: 'beginner', category: 'Governance', educator_id: 6, educator_name: 'David Okonkwo', thumbnail_url: '/assets/images/resource/featured-image-16.jpg', estimatedHours: 13, whatYouLearn: ['Voting mechanisms', 'Treasury management', 'Proposal frameworks', 'Delegation strategies'] },
        { id: 8, title: 'Blockchain Fundamentals', description: 'Start your Web3 journey with this foundational course covering blockchain architecture, consensus mechanisms, and cryptography.', modules_count: 15, enrolled_count: 320, price_usdc: 0, status: 'active', community_id: null, level: 'beginner', category: 'Technical', educator_id: 7, educator_name: 'Guillaume Lauzier', thumbnail_url: '/assets/images/resource/featured-image-17.jpg', estimatedHours: 20, whatYouLearn: ['Blockchain architecture', 'Consensus mechanisms', 'Cryptographic primitives', 'Network topology'] },
        { id: 9, title: 'Solidity Development Bootcamp', description: 'A hands-on bootcamp covering Solidity programming from basics to advanced patterns including gas optimization and proxy contracts.', modules_count: 14, enrolled_count: 198, price_usdc: 45, status: 'active', community_id: null, level: 'intermediate', category: 'Technical', educator_id: 7, educator_name: 'Guillaume Lauzier', thumbnail_url: '/assets/images/resource/featured-image-18.jpg', estimatedHours: 30, whatYouLearn: ['Solidity fundamentals', 'Smart contract patterns', 'Gas optimization', 'Proxy & upgradeability'] },
        { id: 10, title: 'Yield Farming & Liquidity Mining', description: 'Master yield farming strategies across DeFi protocols. Covers auto-compounding, leverage farming, and risk mitigation.', modules_count: 6, enrolled_count: 143, price_usdc: 20, status: 'active', community_id: 3, level: 'intermediate', category: 'DeFi', educator_id: 3, educator_name: 'Aisha Patel', thumbnail_url: '/assets/images/resource/featured-image-1.jpg', estimatedHours: 8, whatYouLearn: ['Farming strategy design', 'Auto-compounding vaults', 'Leverage farming', 'Risk assessment'] }
      ],
      enrollments: [
      ...
      articles: [
        ...
        { id: 12, title: 'Gas Optimization in Solidity', slug: 'gas-optimization-solidity', category: 'Technical', excerpt: 'Practical techniques for optimizing gas consumption in Solidity smart contracts, covering storage packing, function optimization, loop efficiency, and design patterns.', image_url: '/assets/images/learn/cyber_security_crypto.png', published_at: '2024-11-15', profiles: { display_name: 'Guillaume Lauzier', avatar_url: '/assets/images/learn/100.jpg' } },
        { id: 13, title: 'Upgradeable Proxy Contracts', slug: 'upgradeable-proxy-contracts', category: 'Technical', excerpt: 'Explore the major proxy patterns for smart contract upgradeability including Transparent Proxy, UUPS, Beacon, and Diamond patterns with security best practices.', image_url: '/assets/images/learn/smart-contracts.png', published_at: '2024-09-20', profiles: { display_name: 'Guillaume Lauzier', avatar_url: '/assets/images/learn/100.jpg' } }
      ],
      authors: [
